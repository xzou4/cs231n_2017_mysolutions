...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_pool, cache_pool = max_pool_forward_naive(out_conv, pool_param)
        out_hidden, cache_hidden = affine_relu_forward(out_pool, W2, b2)
        scores, cache_affine = affine_forward(out_hidden, W3, b3)
        ...
        dx, grads['W1'], grads['b1'] = conv_relu_backward(dout, cache_conv)
